// local-context.js
// Fill this in with real details about YOUR area. Every persona will naturally
// weave these into conversation where it fits, so students get answers that
// feel like they're about their actual community, not a generic town.
//
// You don't need to touch any other file — this is the only place to edit.
